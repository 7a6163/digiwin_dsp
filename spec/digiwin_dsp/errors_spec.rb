  ...
  describe "#initialize" do
    ...
    it "preserves all kwargs" do
      err = described_class.new("boom",
                                code: "E001", dsp_message: "壞掉了", request_id: "req-1",
                                http_status: 500, response_body: { "x" => 1 })
      expect([err.code, err.dsp_message, err.request_id, err.http_status, err.response_body])
        .to eq(["E001", "壞掉了", "req-1", 500, { "x" => 1 }])
    end
